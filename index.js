...
const categories = async () => {
    const c = await ProductModel.find({}, "-_id").select("product_category_tree").limit(500).lean();
    const mainCategory = [];
    const subCategory = [];
    const leafCategory = [];
    ...
    console.log(uniquemainCategory.length, uniqueSubCategory.length, uniqueLeafCategory.length);
